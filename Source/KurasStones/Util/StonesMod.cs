    ...
    public override void DoSettingsWindowContents(Rect rect) {
			...
			list.Gap(10);
      {
				...
				DualCheckboxesWithIcons_ThingDef(
					fullRect.LeftHalf(), 
					StoneDefOf.ChunkAndesite, StoneDefOf.ChunkAnorthosite, 
					StoneDefOf.Andesite.LabelCap, StoneDefOf.Anorthosite.LabelCap,
					ref Settings.SpawnAndesite, ref Settings.SpawnAnorthosite
                );
                DualCheckboxesWithIcons_ThingDef(
                    fullRect.RightHalf(),
      ...
      list.Gap(10);
			{
				...
				DualCheckboxesWithIcons_ThingDef(
					fullRect.LeftHalf(),
					StoneDefOf.ChunkDunite, StoneDefOf.ChunkEmperadordark,
					StoneDefOf.Dunite.LabelCap, StoneDefOf.Emperadordark.LabelCap,
					ref Settings.SpawnDunite, ref Settings.SpawnEmperadordark
                );
				DualCheckboxesWithIcons_ThingDef(
					fullRect.RightHalf(),
					StoneDefOf.ChunkEtowahMarble, StoneDefOf.ChunkGabbro,
					StoneDefOf.EtowahMarble.LabelCap, StoneDefOf.Gabbro.LabelCap,
					ref Settings.SpawnEtowahMarble, ref Settings.SpawnGabbro
                );
            }
      list.Gap(10);
			{
